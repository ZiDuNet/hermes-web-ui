export default {
  ...
  chat: {
    ...
    workspaceSwitchFailed: '切换工作区失败',
    workspaceAdded: '工作区已添加',
    workspaceAddFailed: '添加工作区失败',
    workspaceAddPlaceholder: '输入路径，如 /home/user/project',
    currentTasks: '当前任务',
  ...
  hermesConfig: {
    ...
    resetDefaults: '恢复默认值',
    defaultsApplied: '已恢复默认值',
    export: '导出',
    import: '导入',
    configImported: '配置已导入',
    invalidJson: '无效的 JSON 文件',
    yamlMode: 'YAML 模式',
    yamlPlaceholder: '# config.yaml 内容',
    categories: {
      general: '通用',
      agent: 'Agent',
      terminal: '终端',
  ...
  hermesKeys: {
    ...
    showAdvanced: '显示高级选项',
    hideAdvanced: '隐藏高级选项',
    providerHint: '这些密钥供 Hermes Agent 网关使用。Web UI 的模型配置请在"模型"页面管理。',
