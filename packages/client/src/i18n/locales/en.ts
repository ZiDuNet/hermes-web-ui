export default {
  ...
  chat: {
    ...
    workspaceAddFailed: 'Failed to add workspace',
    workspaceAddPlaceholder: 'Enter path, e.g. /home/user/project',
  ...
  hermesConfig: {
    ...
    yamlMode: 'YAML Mode',
    yamlPlaceholder: '# config.yaml content',
    categories: {
      general: 'General',
      agent: 'Agent',
      terminal: 'Terminal',
  ...
  hermesKeys: {
    ...
    providerHint: 'These keys are used by the Hermes Agent gateway. For Web UI model configuration, go to the Models page.',
  ...
  mcpServers: {
    ...
    noServers: 'No MCP servers configured. Add one to get started.',
    ...
    urlRequired: 'URL is required for http type',
  },
}
